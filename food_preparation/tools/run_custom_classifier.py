...
def run_custom_classifier(custom_classifier, camera_id=0, path_in=None, path_out=None, title=None, use_gpu=True,
    ...
    display_ops = [
        ...
        sense.display.DisplayTopKClassificationOutputs(top_k=1, threshold=0.60),
    ]
    ...
    #for prediction_value in controller.run_inference():
     #   print('predicted',prediction_value)
